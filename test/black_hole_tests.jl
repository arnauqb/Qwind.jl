...
@testset "Test Black Hole properties" begin
    ...
    @test compute_bolometric_luminosity(black_hole) ≈ 0.5 * compute_eddington_luminosity(black_hole) rtol =
        1e-3
    ...
    @test compute_gravitational_acceleration(earth_radius_rg, 0) ≈ [earth_gravity_rgc2, 0.0] atol=0.0 rtol=0.01
end
